...
import { Interface, Props, State } from 'types/view'
...
class View extends React.PureComponent<Props, State> implements Interface {
				...
				<Form
					...
					result={(fd: Doc, id: string) => {
						...
						if (this.state.formState == 1) {
							...
							this.state.rows[this.state.rows.findIndex((el) => el._id === id)] = fd
						}
					}}
				/>
